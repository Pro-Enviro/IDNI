...
@Component({
  ...
  templateUrl: './hydrogen-power.component.html',
  styleUrl: './hydrogen-power.component.scss'
})
export class HydrogenPowerComponent {
  content:any;

  constructor(private db: DbService) {
    this.db.getContentFromCollection('technologies/5', `
?fields=title,
content,
top_image,
id,
