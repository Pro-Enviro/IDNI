...
@Component({
  ...
  templateUrl: './zero-carbon.component.html',
  styleUrl: './zero-carbon.component.scss'
})
export class ZeroCarbonComponent {
  content:any;

  constructor(private db: DbService) {
    this.db.getContentFromCollection('technologies/2', `
?fields=title,
content,
top_image,
id,
